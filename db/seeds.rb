...
app =  Application.create(
 ...
 :code        => 'vht {vhtcode} {number Number of males:} {number Number of females:} {number Number measured for respiratory rate:} {number Number of RDTs positive:} {number Number of RDTs negative:} {number Number with diarrhoea:} {number Number with fast breathing:} {number Number with fever:} {number Number with danger sign:} {number Number treated within 24 hours:} {number Number treated with ORS:} {number Number treated with Zinc tablet:} {number Number treated with Amoxycillin:} {number Number treated with ACT:} {number Number referred:} {boolean Do you currently have stocks of all medicines?} {boolean Do you currently have RDTs in stock?} {number Total number of new-borns seen:} {number Number of new-borns with danger signs:} {number Number of new-borns referred:}'
  )
